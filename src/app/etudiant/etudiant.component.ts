...
this.apiEndPoint = environment.apiEndPoint;
  ...
  getEtudiants(){
    this.httpClient.get<any>('http://'+this.apiEndPoint+':9001/Etudiants').subscribe(
      response => {
  ...
  // tslint:disable-next-line:typedef
  onSubmit(f: NgForm) {
    const url = 'http://'+this.apiEndPoint+':9001/Etudiants/ajouter';
  ...
  // tslint:disable-next-line:typedef
  onSave() {
    const editURL = 'http://'+this.apiEndPoint+':9001/Etudiants/' + this.editForm.value.id + '/editer';
  ...
  // tslint:disable-next-line:typedef
  onDelete() {
    const deleteURL = 'http://'+this.apiEndPoint+':9001/Etudiants/' + this.deleteId + '/supprimer';
